...
public class CategoryViewAttsTest {
	...
	public void testClone2() {
		MCategoryViewAttributes viewAtts = new MCategoryViewAttributes(false, IMAGE, "title2", FONT);
		CategoryViewAttributes clone = viewAtts.clone();
		assertEquals(viewAtts, clone);
		assertNotSame(viewAtts, clone);
	}
	...
	public void testClone3() {
		MCategoryViewAttributes viewAtts = new MCategoryViewAttributes(true, IMAGE, "title", FONT);
		CategoryViewAttributes clone = viewAtts.clone();
		assertEquals(viewAtts, clone);
		assertNotSame(viewAtts, clone);
	}
	...
	public void testEqualsObject1() {
		...
		CategoryViewAttributes viewAtts2 = new MCategoryViewAttributes(false, IMAGE, "title", FONT);
		assertEquals(viewAtts1, viewAtts2);
	}
	
	@Test
	public void testEqualsObject2() {
		CategoryViewAttributes viewAtts1 = new MCategoryViewAttributes(true, IMAGE, "title", FONT);
	...
	public void testEqualsObject3() {
		CategoryViewAttributes viewAtts1 = new MCategoryViewAttributes(false, IMAGE, "title", FONT2);
		CategoryViewAttributes viewAtts2 = new MCategoryViewAttributes(false, IMAGE, "title", FONT2);
		assertEquals(viewAtts1, viewAtts2);
	}
	
	@Test
	public void testNotEqualsObject1(){
		CategoryViewAttributes viewAtts1 = new MCategoryViewAttributes(false, IMAGE, "title2", FONT);
		CategoryViewAttributes viewAtts2 = new MCategoryViewAttributes(false, IMAGE, "title", FONT);
