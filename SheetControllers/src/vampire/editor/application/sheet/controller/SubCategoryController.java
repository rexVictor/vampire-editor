...
public class SubCategoryController extends AbstractNonLeafController<SubCategory, SubCategoryView, SubCategoryListener,
													TraitControllerAPI, TraitAPI, Trait, TraitView, SubCategoryEventAPI> 
										implements SubCategoryControllerAPI {
	
	public SubCategoryController(SubCategory subCategory, SubCategoryView view) {
		super(subCategory, view);
	}
